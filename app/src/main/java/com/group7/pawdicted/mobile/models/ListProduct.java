...
public class ListProduct {
    ...
    public void generate_sample_dataset() {
        ...
        products.add(new Product("FT0009", "CIAO Tuna & Scallop", new ArrayList<>(), new ArrayList<>(), 20.000,
        ...
        // FT: TR (Treats)
        products.add(new Product("FT0015", "Chicken Jerky", new ArrayList<>(), new ArrayList<>(), 15.000,
        ...
        // PC: HE (Health)
        products.add(new Product("PC0009", "BIOLINE Ear Care Ear Drops", new ArrayList<>(), new ArrayList<>(), 150.000,
        ...
        // PC: GR (Grooming)
        products.add(new Product("PC0015", "Pet Shampoo", new ArrayList<>(), new ArrayList<>(), 100.000,
        ...
        // FU: BE (Bed)
        products.add(new Product("FU0009", "Sunny Daze Air Dog Bed", new ArrayList<>(), new ArrayList<>(), 1200.000,
        ...
        products.add(new Product("FU0010", "Pet Crate", new ArrayList<>(), new ArrayList<>(), 800.000,
        ...
        // TO: TY (Toys)
        products.add(new Product("TO0009", "PAW Ultrasonic Dog Whistles", new ArrayList<>(), new ArrayList<>(), 200.000,
        ...
        // TO: TN (Training)
        products.add(new Product("TO0010", "Training Pad", new ArrayList<>(), new ArrayList<>(), 50.000,
        ...
        products.add(new Product("AC0009", "Polka Dot Collar", new ArrayList<>(), new ArrayList<>(), 250.000,
        ...
        products.add(new Product("AC0010", "Pet Sweater", new ArrayList<>(), new ArrayList<>(), 300.000,
        ...
        // AC: FE (Feeders)
        products.add(new Product("AC0011", "Automatic Feeder", new ArrayList<>(), new ArrayList<>(), 500.000,
        ...
        // CK: CA (Carriers)
        products.add(new Product("CK0009", "Travel Dog Bottle", new ArrayList<>(), new ArrayList<>(), 350.000,
        ...
        // CK: KE (Kennels)
        products.add(new Product("CK0010", "Pet Kennel", new ArrayList<>(), new ArrayList<>(), 600.000,
